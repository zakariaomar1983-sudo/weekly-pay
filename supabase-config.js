(function loadSupabaseConfig() {
  ...
  const trimmedStoredUrl = storedUrl.trim();
  const trimmedStoredAnon = storedAnon.trim();
  const storedConfig = trimmedStoredUrl && trimmedStoredAnon
    ? { url: trimmedStoredUrl, anonKey: trimmedStoredAnon }
    : null;
